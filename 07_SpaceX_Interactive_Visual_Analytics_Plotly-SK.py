...
def get_pie_chart(entered_site):
    if entered_site == 'All Sites':
        ...
        pieSuccess = 'Success (' + str(len(spacex_df[spacex_df['Launch Site']==str(entered_site)][spacex_df['class']==1])) + ')'
        pieFailure = 'Failure (' + str(len(spacex_df[spacex_df['Launch Site']==str(entered_site)][spacex_df['class']==0])) + ')'
        fig = px.pie(values=spacex_df[spacex_df['Launch Site']==str(entered_site)]['class'].value_counts(normalize=True),# hole=.3, 
                     names={1: pieSuccess
                            , 0: pieFailure
                            },
                     labels=spacex_df[spacex_df['Launch Site']==str(entered_site)]['class'].value_counts(),
